...
public class LengthHeapSort {
    public static void main(String[] args) throws FileNotFoundException, UnsupportedEncodingException {
        ...
        File arquivoMelhor = new File("sort/passwords_length_heapSort_medioCaso.csv");
        String arquivoMelhorCaso = arquivoMelhor.getAbsolutePath();

        File arquivoPior = new File("sort/passwords_length_heapSort_melhorCasoCrescente.csv");
    ...
    public static void medioCaso(String arquivoPassClass) throws FileNotFoundException, UnsupportedEncodingException {
        ...
        // Encontrar o tamanho máximo e mínimo
        ...
        // Criar o array auxiliar para ordenação
        ...
        // Executar o Heap Sort nas senhas ordenadas por tamanho
        for (int tamanho = 1; tamanho < ordenadas.length; tamanho++) {
            String[] temp = ordenadas[tamanho];
            int j = tamanho;
            while (j > 0 && Integer.parseInt(ordenadas[j - 1][2]) < Integer.parseInt(temp[2])) {
        ...
        PrintWriter writer = new PrintWriter("sort/passwords_length_heapSort_medioCaso.csv", "UTF-8");
    ...
    public static void melhorCaso(String arquivoMelhorCaso) throws FileNotFoundException, UnsupportedEncodingException {
        ...
        // Impressão das senhas ordenadas
        PrintWriter writer = new PrintWriter("sort/passwords_length_heapSort_melhorCaso.csv", "UTF-8");
        writer.print(",password,length,data,class\n");
        for (i = 0; i < linhas; i++) {
            writer.println(i + "," + ordenadas[i][1] + "," + ordenadas[i][2] + "," + ordenadas[i][3] + "," + ordenadas[i][4]);
        }
    ...
    public static void inverter(String arquivoMelhorCaso) throws FileNotFoundException, UnsupportedEncodingException {
        ...
        // Impressão das senhas ordenadas
        PrintWriter writer = new PrintWriter("sort/passwords_length_heapSort_melhorCasoCrescente.csv", "UTF-8");
        writer.print(",password,length,data,class\n");
        for (i = 0; i < linhas; i++) {
            writer.println(i + "," + ordenadas[i][1] + "," + ordenadas[i][2] + "," + ordenadas[i][3] + "," + ordenadas[i][4]);
        }
    ...
    public static void piorCaso(String arquivoPiorCaso) throws FileNotFoundException, UnsupportedEncodingException {
        ...
        // Impressão das senhas ordenadas
        PrintWriter writer = new PrintWriter("sort/passwords_length_heapSort_piorCaso.csv", "UTF-8");
        writer.print(",password,length,data,class\n");
        for (i = 0; i < linhas; i++) {
            writer.println(i + "," + ordenadas[i][1] + "," + ordenadas[i][2] + "," + ordenadas[i][3] + "," + ordenadas[i][4]);
        }
